...
* @returns {any}
*/
module.exports.decode_abi_wrapper = function(file_content, data) {
    try {
...
* @returns {any}
*/
module.exports.decode_input_from_js = function(file_content, data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(file_content, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.decode_output_wrapper = function(file_content, signature, data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(file_content, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.decode_output_from_js = function(file_content, signature, data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(file_content, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
* @returns {any}
*/
module.exports.encode_input_from_js = function(file_content, signature, params) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(file_content, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
module.exports.__wbg_log_c2e8afcea400d50a = function(arg0) {
...
const path = require('path').join(__dirname, 'ola_lang_abi_bg.wasm');
